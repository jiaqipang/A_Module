...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jiaqipang/A_Module"
  ...
  s.source       = { :git => "https://github.com/jiaqipang/A_Module.git", :tag => s.version.to_s }
  ...
  s.source_files  = "A_Module/A_Module/**/*.{h,m,swift}"
  ...
  s.dependency "B_Module_Category"
